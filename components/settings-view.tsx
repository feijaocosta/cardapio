...
import { getShowPrice, setShowPrice, getLayoutModel, setLayoutModel } from '../services/api';
import { Settings, Eye, EyeOff, LayoutGrid, List, Zap } from 'lucide-react';
...
export function SettingsView({ onSettingsChange }: SettingsViewProps) {
  ...
  const loadSettings = async () => {
    try {
      setIsLoading(true);
      const [price, layout] = await Promise.all([
        getShowPrice(),
        getLayoutModel()
      ]);
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8 pb-8 border-b border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Escolha como os itens serão exibidos no cardápio do cliente.
            </p>
